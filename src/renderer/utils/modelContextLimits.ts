...
const MODEL_CONTEXT_LIMITS: Record<string, number> = {
  ...
  // OpenAI GPT-5 series (current - Feb 2026)
  'gpt-5.2': 400_000,
  ...
  'gpt-5-mini': 400_000,
  'gpt-5-nano': 400_000,
  // OpenAI GPT-4.1 series (non-reasoning, ~1M context)
  'gpt-4.1': 1_047_576,
  'gpt-4.1-mini': 1_047_576,
  'gpt-4.1-nano': 1_047_576,
  // OpenAI o-series (reasoning - legacy, succeeded by GPT-5)
  o3: 200_000,
  'o3-mini': 200_000,
  'o3-pro': 200_000,
  'o4-mini': 200_000,
  ...
  'o1-preview': 128_000,
  'o1-mini': 128_000,
  // OpenAI GPT-4o series (retiring Feb 2026)
  'gpt-4o': 128_000,
  'gpt-4o-mini': 128_000,
  // OpenAI legacy
  'gpt-4-turbo': 128_000,
