...
const DiffPreview: React.FC<DiffPreviewProps> = ({
	...
	const { selectedText, selectionPosition, clearSelection } =
	...
	const isMarkdownContent =
		metadata?.title?.toLowerCase().endsWith(".md") ||
		metadata?.title?.toLowerCase().endsWith(".markdown");
