...
export const conversation = {
	...
	get: bridge.buildProvider<TChatConversation, { id: string }>(
		"get-conversation",
	), // Get conversation information
	getAssociateConversation: bridge.buildProvider<
		TChatConversation[],
		{ conversation_id: string }
	>("get-associated-conversation"), // Get associated conversations
	...
	>("update-conversation"), // Update conversation information
...
export const application = {
	...
	>("system.update-info"), // Update system information
...
export const fs = {
	...
	>("get-file-by-dir"), // Get list of folders and files in specified directory
...
export const mode = {
	fetchModelList: bridge.buildProvider<
		IBridgeResponse<{ mode: Array<string>; fix_base_url?: string }>,
		{ base_url?: string; api_key: string; try_fix?: boolean; platform?: string }
	>("mode.get-model-list"),
...
export const webui = {
	// Get WebUI status
	getStatus: bridge.buildProvider<IBridgeResponse<IWebUIStatus>, void>(
		"webui.get-status",
	),
	// Start WebUI
	...
	changePassword: bridge.buildProvider<
		IBridgeResponse,
		{ newPassword: string }
	>("webui.change-password"),
	// Reset password (generate new random password)
	resetPassword: bridge.buildProvider<
		IBridgeResponse<{ newPassword: string }>,
		void
