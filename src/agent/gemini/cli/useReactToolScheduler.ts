...
/**
 * Hook to manage tool call scheduling and status tracking for React components.
 *
 * Note: onEditorClose callback was removed from CoreToolSchedulerOptions in aioncli-core v0.18.4.
 */
