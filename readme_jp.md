...
*AionUi には Gemini CLI を内蔵しており、ダウンロードしてすぐ使えます。追加インストール不要です。すでに Gemini CLI、Claude Code、CodeX、Qwen Code、Goose AI、Augment Code などのコマンドラインツールをインストールしている場合、AionUi が自動検出して統一されたグラフィカルインターフェースを提供し、体験がさらに豊かになります*
...
*あなたの 7×24 時間 AI アシスタント - 任意のデバイス、どこからでもAionUiにアクセス！出張中、自宅、オフィス、いつでもどこでもWebUIまたはTelegramを通じてAIツールを使用*
...
*スケジュールタスクを設定すると、AIアシスタントが設定した時間に自動的に実行され、真の7×24時間無人運用を実現*
...
*9种类以上の形式のビジュアルプレビューをサポート（PDF、Word、Excel、PPT、コード、Markdown、画像、HTML、Diffなど）*
...
*Gemini、OpenAI、Claude、Qwenなどの主流モデル、およびOllama、LM Studioなどのローカルモデルをサポート。さまざまなタスク要件を満たすために、異なるモデル間を柔軟に切り替え。*
...
*独自のCSSコードでカスタマイズし、インターフェースを好みに合わせる*
...
*複数の会話を開く、タスクが混乱しない、記憶が独立、効率が倍増*
...
*クリエイターたちがAionUiをレビュー・使用する様子をご覧ください*
